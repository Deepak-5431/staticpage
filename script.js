document.addEventListener('DOMContentLoaded', function() {
    ...
    const stepData = [
        ...
        },
        {
            ...
            content: '<div class="step-content" style="margin-bottom: 16px;"><p>The given equation is a quadratic equation in the form \\( ax^2 + bx + c = 0 \\), where \\( a = 1 \\), \\( b = -7 \\), and \\( c = 3 \\).</p><div class="related-concept-inline" style="background: #f0f8ff; padding: 12px; border-radius: 6px; margin-top: 16px; border-left: 3px solid #016DAB;"><div style="font-weight: 600; color: #016DAB; margin-bottom: 8px;">📚 Related Concept:</div><div style="font-size: 14px; color: #333;"><strong>Quadratic Equations:</strong> A quadratic equation is a polynomial equation of degree 2 in the form \\( ax^2 + bx + c = 0 \\), where \\( a \\neq 0 \\). The coefficients \\( a \\), \\( b \\), and \\( c \\) are real numbers.</div></div></div>'
        },
        {
            question: '<b>Step 2: Apply the Quadratic Formula</b>',
            content: '<div class="step-content" style="margin-bottom: 16px;"><p>Use the quadratic formula \\( x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a} \\) to find the roots of the equation. Substitute \\( a = 1 \\), \\( b = -7 \\), and \\( c = 3 \\) into the formula.</p><div class="related-concept-inline" style="background: #f0f8ff; padding: 12px; border-radius: 6px; margin-top: 16px; border-left: 3px solid #016DAB;"><div style="font-weight: 600; color: #016DAB; margin-bottom: 8px;">📚 Related Concept:</div><div style="font-size: 14px; color: #333;"><strong>Quadratic Formula:</strong> The quadratic formula \\( x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a} \\) provides the solutions to any quadratic equation. The ± symbol indicates there are typically two solutions.</div></div></div>'
        },
        {
            question: '<b>Step 3: Calculate the Discriminant</b>',
            content: '<div class="step-content" style="margin-bottom: 16px;"><p>Compute the discriminant \\( b^2 - 4ac = (-7)^2 - 4 \\times 1 \\times 3 = 49 - 12 = 37 \\).</p><div class="related-concept-inline" style="background: #f0f8ff; padding: 12px; border-radius: 6px; margin-top: 16px; border-left: 3px solid #016DAB;"><div style="font-weight: 600; color: #016DAB; margin-bottom: 8px;">📚 Related Concept:</div><div style="font-size: 14px; color: #333;"><strong>Discriminant:</strong> The discriminant \\( \\Delta = b^2 - 4ac \\) determines the nature of roots. If \\( \\Delta > 0 \\), there are two distinct real roots; if \\( \\Delta = 0 \\), one repeated real root; if \\( \\Delta < 0 \\), two complex roots.</div></div></div>'
        },
        {
    ...
    function showSolutionStep(stepNumber) {
        ...
        const targetStep = document.getElementById('solution-step-' + stepNumber);
        if (targetStep) {
